...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Mod Team'],
			['ChromaCee',		'clear',		'Director\nMain Programmer\nMain Artist/Animator',	'https://twitter.com/ChromaCee',									'7F5D7C'],
			['Megalo',			'clear',		'Main Composer',									'https://twitter.com/MegaloFNF',									'7F5D7C'],
			...
			[''],
			['Special Thanks'],
			['ManlyPotato',		'clear',		'Composer of "Im Gay BTW Not Sure If That Matters"',				'https://manlypotato.newgrounds.com/',	'7F5D7C'],
			[''],
			['Psych Engine Team'],
