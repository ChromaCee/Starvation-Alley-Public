...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Advanced Alt Sing Animation', "Advanced version of the Alt Animation feature\nSets a specified suffix after the sing animation name.\nYou can use this to trigger a secondary alt animation, such as 'singLEFT-alttwo' if you set\nValue 2 to -alttwo\n\nValue 1: Character to set (Dad, BF or GF)\nValue 2: New suffix (Leave it blank to disable)"],
		['Screen Shake', "Value 1: Camera shake\nValue 2: HUD shake\n\nEvery value works as the following example: \"1, 0.05\".\nThe first number (1) is the duration.\nThe second number (0.05) is the intensity."],
		['Change Character', "Value 1: Character to change (Dad, BF, GF)\nValue 2: New character's name"],
		['Change Scroll Speed', "Value 1: Scroll Speed Multiplier (1 is default)\nValue 2: Time it takes to change fully in seconds."],
		['Fade HUD', "fades the HUD from existence"],
		['Unfade HUD', "Opposite of 'fade HUD.'"],
		['Sunrise', "Triggers the sunrise.\nShould be used only in \"alley\" Stage!"],
		['Bite', "Plays the Bite Sound."],
	];
	...
	**/
	...
	var check_secondAltAnim:FlxUICheckBox;
	...
	function addSectionUI():Void
	{
		...
		check_secondAltAnim = new FlxUICheckBox(130, 60, null, null, "Second Alt Animation", 100);
		check_secondAltAnim.checked = _song.notes[curSection].secondAltAnim;
		check_secondAltAnim.name = 'check_secondAltAnim';
		...
		tab_group_section.add(check_secondAltAnim);
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>)
	{
		if (id == FlxUICheckBox.CLICK_EVENT)
		{
			...
			switch (label)
			{
				...
				case "Second Alt Animation":
					_song.notes[curSection].secondAltAnim = check.checked;
			}
		}
	...
	function updateSectionUI():Void
	{
		...
		check_altAnim.checked = sec.secondAltAnim;
